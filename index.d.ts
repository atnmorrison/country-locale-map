...
interface CLM {
  ...
  getCountryByAlpha2: (alpha2: string) => string;
  ...
  getCountryByAlpha3: (alpha3: string) => string;
  ...
  getCountryByNumeric: (numeric: string) => string;
  ...
  getCountryByName: (name: string, fuzzy?: boolean) => string;
}
